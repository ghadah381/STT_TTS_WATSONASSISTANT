...
authenticator = IAMAuthenticator('8kbLd5nBuUPTp3jF3LdVoq29fmC0YmQWfVfdIqSsX0wF') 
tts = TextToSpeechV1(authenticator=authenticator)
tts.set_service_url('https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/cc2a13af-5a9c-4038-aa17-1415d5f05b67')


authenticator = IAMAuthenticator('hjxrW6ICGr2W1IuX5VzTXQrGQeTm7kOiJQHPWFfSWKyL')
assistant = AssistantV2(version='2020-04-01', authenticator = authenticator)
assistant.set_service_url('https://api.us-south.assistant.watson.cloud.ibm.com/instances/821e5c49-6ee0-4336-b867-0146c477af09')
...
def main():
    ...
    response = assistant.message_stateless(
     assistant_id='0a85d849-682b-4a4b-bc1b-5723b40c92d0', 
